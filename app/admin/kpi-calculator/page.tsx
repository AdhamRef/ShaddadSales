          ...
          <div className="">
            {/* Header */}
              ...
              <div className="flex items-center gap-4 mb-2">
                ...
                <h1 className="text-4xl font-bold">لوحة مؤشرات الأداء الرئيسية</h1>
              </div>
 ...
 <div className="flex-1 overflow-auto p-4 lg:p-6">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 font-semibold">مقاييس شاملة لأداء الفريق</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Bar Chart */}
          <Card className="py-0 border-0 shadow-2xl bg-white/80 backdrop-blur-sm hover:shadow-3xl transition-all duration-300">
            ...
            <CardContent className="p-6">
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData[0] ? [radarData[0]] : []}>
                  ...
                  <PolarAngleAxis dataKey="agent" tick={{ fill: '#4b5563', fontSize: 13, fontWeight: 'bold' }} />
                  <PolarRadiusAxis angle={90} domain={[0, 100]} />
                  <Radar name={radarData[0]?.agent} dataKey="معدل الإغلاق" stroke="#10b981" fill="#10b981" fillOpacity={0.7} strokeWidth={2} />
                  <Radar name={radarData[0]?.agent} dataKey="تحويل المكالمات" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.7} strokeWidth={2} />
                  <Radar name={radarData[0]?.agent} dataKey="وقت الاستجابة" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.7} strokeWidth={2} />
                  <Radar name={radarData[0]?.agent} dataKey="العملاء المؤهلين" stroke="#f59e0b" fill="#f59e0b" fillOpacity={0.7} strokeWidth={2} />
          ...
          <CardContent className="p-6">
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={performanceChartData}>
                ...
                <Bar dataKey="العملاء المؤهلين" fill="url(#leadGradient)" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card className="py-0 border-0 shadow-2xl bg-white/80 backdrop-blur-sm overflow-hidden">
