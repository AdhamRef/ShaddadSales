...
"[project]/app/api/qualified-leads/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const leads = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qualifiedLead.findMany({
            where,
            include: {
                agent: {
                    select: {
...
async function POST(request) {
    try {
        ...
        const lead = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qualifiedLead.create({
            data: {
...
async function PUT(request) {
    try {
        ...
        const existingLead = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qualifiedLead.findUnique({
            where: {
                id
            }
        });
        ...
        const lead = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qualifiedLead.update({
            where: {
                id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f399635._.js.map